...
function preload() {
  ...
  principalesList[2] = loadImage('/data/principal/BODY.png');
  principalesList[3] = loadImage('/data/principal/BOOBS.png');
  principalesList[4] = loadImage('/data/principal/BOUCHE.png');
  principalesList[5] = loadImage('/data/principal/CREW.png');
  principalesList[6] = loadImage('/data/principal/CUL SHORT.png');
  principalesList[7] = loadImage('/data/principal/CUL VELO.png');
  principalesList[8] = loadImage('/data/principal/CUL.png');
  principalesList[9] = loadImage('/data/principal/DAVID2.png');
  principalesList[10] = loadImage('/data/principal/ESPADON.png');
  principalesList[11] = loadImage('/data/principal/FEMME DOS.png');
  principalesList[12] = loadImage('/data/principal/LIBERTAD.png');
  principalesList[13] = loadImage('/data/principal/MAGNUM.png');
  principalesList[14] = loadImage('/data/principal/MAGNUM2.png');
  principalesList[15] = loadImage('/data/principal/MEUFS.png');
  principalesList[16] = loadImage('/data/principal/PAMELA.png');
  principalesList[17] = loadImage('/data/principal/RICHARD.png');
  principalesList[18] = loadImage('/data/principal/TENNIS.png');
  principalesList[19] = loadImage('/data/principal/VOLLEY.png');
  principalesList[20] = loadImage('/data/principal/WAW.png');

  fontsList[0] = loadImage('/data/typo/13.png');
  fontsList[1] = loadImage('/data/typo/1.png');
  fontsList[2] = loadImage('/data/typo/2.png');
  fontsList[3] = loadImage('/data/typo/3.png');
  fontsList[4] = loadImage('/data/typo/4.png');
  fontsList[5] = loadImage('/data/typo/5.png');
  fontsList[6] = loadImage('/data/typo/6.png');
  fontsList[7] = loadImage('/data/typo/7.png');
  fontsList[8] = loadImage('/data/typo/8.png');
  fontsList[9] = loadImage('/data/typo/9.png');
  fontsList[10] = loadImage('/data/typo/10.png');
  fontsList[11] = loadImage('/data/typo/11.png');
  fontsList[12] = loadImage('/data/typo/12.png');
